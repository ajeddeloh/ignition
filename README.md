...
Ignition has two main development branches: master and spec2x. This is spec2x which is for Ignition included in Container Linux. For new Ignition development see the master branch.
